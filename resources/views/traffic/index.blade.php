...
<head>
    ...
    <title>Website Traffic - {{ config('app.name', 'Laravel') }}</title>
    <!-- Fonts -->
...
<body class="font-sans antialiased text-gray-900 bg-gray-50">
    <div class="min-h-screen bg-gray-50">
        ...
        <!-- Main Content -->
        <main id="traffic-list" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div class="mb-16">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="group bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col" style="border-top: 3px solid transparent;" onmouseenter="this.style.borderTop='3px solid #ff6b00'" onmouseleave="this.style.borderTop='3px solid transparent'">
                            ...
                            <a href="{{ route('traffic.show', $service) }}" class="w-full inline-flex items-center justify-center bg-brand hover:opacity-90 text-white font-bold text-sm py-3 px-4 rounded-xl transition-all duration-200 shadow-md">
                                View Packages
