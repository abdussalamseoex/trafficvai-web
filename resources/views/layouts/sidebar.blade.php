    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar pb-10">
        <nav class="mt-6 px-4 space-y-2">
            ...
            @if(Auth::user()->is_admin)
                ...
                <x-sidebar-dropdown title="Blog & Content" :active="request()->routeIs('admin.posts.*') || request()->routeIs('admin.pages.*') || request()->routeIs('admin.home-sections.*') || request()->routeIs('admin.announcements.*') || request()->routeIs('admin.site-faqs.*') || request()->routeIs('admin.bulk-emails.*') || request()->routeIs('admin.email-lists.*')">
                    <x-slot name="icon">
                    ...
                    <x-sidebar-link :href="route('admin.bulk-emails.index')" :active="request()->routeIs('admin.bulk-emails.*')">
                        {{ __('Bulk Emails') }}
                    </x-sidebar-link>
                    <x-sidebar-link :href="route('admin.email-lists.index')" :active="request()->routeIs('admin.email-lists.*')">
                        {{ __('Email Lists') }}
                    </x-sidebar-link>
            ...
            @else
                ...
                <!-- SECTION 2: CORE MARKETPLACE & SEO SERVICES -->
                <p class="px-4 text-[10px] font-extrabold uppercase tracking-wider mb-2 mt-6" style="color: #F97316;">SEO & Marketplace</p>
                
                <x-sidebar-link :href="route('client.guest_posts.index')" :active="request()->routeIs('client.guest_posts.*')">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" style="color: #10B981;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path></svg>
                    <span class="flex-1 font-bold">{{ __('Guest Post Inventory') }}</span>
                    <span class="text-[10px] font-extrabold px-2 py-0.5 rounded" style="background-color: rgba(16, 185, 129, 0.15); color: #34D399;">DA 50+</span>
                </x-sidebar-link>

                <x-sidebar-link :href="route('client.services.index')" :active="request()->routeIs('client.services.*')">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" style="color: #F97316;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    <span class="flex-1 font-bold">{{ __('SEO Packages') }}</span>
                </x-sidebar-link>

                <x-sidebar-link :href="route('client.link_building.index')" :active="request()->routeIs('client.link_building.*')">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" style="color: #60A5FA;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"></path></svg>
                    <span class="flex-1">{{ __('Authority Link Building') }}</span>
                </x-sidebar-link>

                <x-sidebar-dropdown title="SEO Campaigns" :active="request()->routeIs('client.seo_campaigns.*') || request()->routeIs('client.campaigns.*')">
                    <x-slot name="icon">
