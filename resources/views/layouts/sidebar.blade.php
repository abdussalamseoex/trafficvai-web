    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar pb-10">
        <nav class="mt-6 px-4 space-y-2">
            ...
            @if(Auth::user()->is_admin)
                ...
                <x-sidebar-dropdown title="Blog & Content" :active="request()->routeIs('admin.posts.*') || request()->routeIs('admin.pages.*') || request()->routeIs('admin.home-sections.*') || request()->routeIs('admin.announcements.*') || request()->routeIs('admin.site-faqs.*') || request()->routeIs('admin.bulk-emails.*')">
                    <x-slot name="icon">
