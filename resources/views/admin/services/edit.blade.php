        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.services.update', $service) }}" enctype="multipart/form-data" x-data="serviceEditForm()">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-8 border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">Recommended: 1200×700px, jpg/png/webp, max 4MB. Upload a new file to replace the current one.</p>
