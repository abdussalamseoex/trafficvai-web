                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-500">
                                            @if($category->parent)
                                                <span class="text-indigo-600 border border-indigo-200 bg-indigo-50 px-2 py-0.5 rounded-full text-xs mr-2">{{ $category->parent->name }}</span>
                                            @endif
                                            /{{ $category->slug }}
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.categories.show', $category) }}" class="text-green-600 hover:text-green-900 mr-3">View</a>
