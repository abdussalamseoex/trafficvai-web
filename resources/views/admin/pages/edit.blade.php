                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div class="md:col-span-2 space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="title" id="title" value="{{ old('title', $page->title) }}" required class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm text-lg border-gray-300 rounded-md">
                            ...
                            <div class="space-y-6 bg-gray-50 p-5 rounded-xl border border-gray-100">
                                ...
                                <div>
                                    <label for="is_active" class="flex items-center mt-2">
                                        <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $page->is_active) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="hero_badge" id="hero_badge" value="{{ old('hero_badge', $page->hero_badge) }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm text-sm border-gray-300 rounded-md" placeholder="e.g. Our Story">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="hero_description" id="hero_description" rows="3" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm text-sm border-gray-300 rounded-md" placeholder="Short intro text for the hero section">{{ old('hero_description', $page->hero_description) }}</textarea>
                                ...
                                <x-seo-form-tabs :model="$page" />

                                <div class="mt-8 pt-4 border-t border-gray-200">
                                    <p class="text-xs text-gray-500"><strong>Public URL:</strong></p>
                                    <a href="{{ url('/page/' . $page->slug) }}" target="_blank" class="text-xs text-indigo-600 hover:underline break-all">{{ url('/page/' . $page->slug) }}</a>
                                </div>
