                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="ownership_type" name="ownership_type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    ...
                                    <option value="Contributor" {{ old('ownership_type') == 'Contributor' ? 'selected' : '' }}>Contributor</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="express_delivery_price" class="block mt-1 w-full" type="number" step="0.01" name="express_delivery_price" min="0" :value="old('express_delivery_price', 0)" placeholder="e.g. 0" />
                                <p class="text-xs text-gray-500 mt-1">Price for express delivery (default: $0)</p>
