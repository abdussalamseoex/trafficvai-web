                    ...
                    <form method="POST" action="{{ route('admin.guest-posts.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="express_delivery_price" class="block mt-1 w-full" type="number" step="0.01" name="express_delivery_price" min="0" :value="old('express_delivery_price')" placeholder="e.g. 50" />
