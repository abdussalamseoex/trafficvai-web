        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.campaigns.store', $type) }}" enctype="multipart/form-data" x-data="serviceCreateForm()">
                        @csrf
                        ...
                        <div class="mb-8 border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <x-input-label for="name" :value="__($title . ' Package Name')" />
                                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus placeholder="e.g. Premium Package" x-on:input="generateSlug($event.target.value)" />
                        ...
                        <div class="flex items-center justify-between mt-8 pt-6 border-t">
                            ...
                            <div class="flex space-x-4">
                                <a href="{{ route('admin.campaigns.index', $type) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition shadow-sm">
                                    Cancel
                                </a>
