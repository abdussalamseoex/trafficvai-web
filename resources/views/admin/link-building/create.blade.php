        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.link-building.store') }}" enctype="multipart/form-data" x-data="serviceCreateForm()">
                        @csrf
                        ...
                        <div class="flex items-center justify-between mt-8 pt-6 border-t">
                            ...
                            <div class="flex space-x-4">
                                <a href="{{ route('admin.link-building.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition shadow-sm">
                                    Cancel
                                </a>
