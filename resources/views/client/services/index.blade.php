        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-12">
                <p class="text-xl text-gray-500">
                    Choose from our result-driven SEO link building and guest posting packages.
                </p>
            </div>
                        ...
                        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 group">
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                ...
                                <div class="shrink-0 mt-6 md:mt-0">
                                    <a href="{{ route('client.services.show', $service) }}" class="inline-flex items-center justify-center w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-xl transition duration-150 shadow-md">
                                        View Details
            ...
            @if ($uncategorizedServices->count() > 0)
                <div class="mb-16">
                    ...
                    <h2 class="text-3xl font-extrabold text-gray-900 mb-6 tracking-tight">Other Services</h2>
                    @endif
                    <div class="space-y-6">
