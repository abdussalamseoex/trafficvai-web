    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                <!-- All Orders -->
                <a href="{{ route('client.orders.index') }}" class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all group {{ !request('status') ? 'ring-2 ring-indigo-500' : '' }}">
                    <div class="flex flex-col">
                        <span class="text-xs font-black text-gray-500 uppercase tracking-widest mb-1">My All Orders</span>
                        <span class="text-2xl font-black text-gray-900">{{ $statusCounts['all'] }}</span>
                    </div>
                </a>

                <!-- Awaiting Payment -->
                <a href="{{ route('client.orders.index', ['status' => 'pending_payment']) }}" class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all group {{ request('status') == 'pending_payment' ? 'ring-2 ring-yellow-500' : '' }}">
                    <div class="flex flex-col">
                ...
                <!-- Action Required -->
                <a href="{{ route('client.orders.index', ['status' => 'pending_requirements']) }}" class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all group {{ request('status') == 'pending_requirements' ? 'ring-2 ring-orange-500' : '' }}">
                    <div class="flex flex-col">
                        <span class="text-xs font-black text-orange-600 uppercase tracking-widest mb-1">Action Required</span>
                ...
                <!-- Processing -->
                <a href="{{ route('client.orders.index', ['status' => 'processing']) }}" class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all group {{ request('status') == 'processing' ? 'ring-2 ring-blue-500' : '' }}">
                    <div class="flex flex-col">
                ...
                <!-- Completed -->
                <a href="{{ route('client.orders.index', ['status' => 'completed']) }}" class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all group {{ request('status') == 'completed' ? 'ring-2 ring-green-500' : '' }}">
                    <div class="flex flex-col">
