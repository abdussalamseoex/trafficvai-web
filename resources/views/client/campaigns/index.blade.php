                        ...
                        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 group">
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                ...
                                <div class="shrink-0 mt-6 md:mt-0">
                                    @php
                                        $showRoute = ($type === 'link-building') ? route('client.link_building.show', $service->slug) : (preg_match('/^(seo-campaigns|keyword-research|on-page-seo|technical-seo|local-seo|content-seo|seo-audit|monthly-seo|e-commerce-seo)$/', $type) ? route('client.seo_campaigns.show', ['type' => $type, 'service' => $service->slug]) : route('client.campaigns.show', ['type' => $type, 'service' => $service->slug]));
                                    @endphp
                                    <a href="{{ $showRoute }}" class="inline-flex items-center justify-center w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-xl transition duration-150 shadow-md">
                                        View Details
