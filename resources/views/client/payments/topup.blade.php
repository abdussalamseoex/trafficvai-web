                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                            @foreach($methods as $slug => $gateway)
                                                ...
                                                <label class="relative cursor-pointer border bg-gray-50 hover:bg-gray-100 rounded-xl px-4 py-3 flex items-center gap-3 transition flex-1 min-w-[150px]"
                                                    ...
                                                    <span class="text-gray-900 font-bold text-sm flex flex-col justify-center">
                                                        {{ $gateway['name'] }}
