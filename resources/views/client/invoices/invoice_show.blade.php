<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                        ...
                        @foreach($gateways as $id => $gateway)
                            ...
                            <label class="relative flex flex-col p-4 border-2 rounded-2xl cursor-pointer transition group"
                                ...
                                <div class="flex items-center gap-3 mb-2">
                                    <div class="w-10 h-10 bg-gray-100 rounded-xl flex items-center justify-center overflow-hidden">
                                        @if(isset($gateway['logo']))
                                            <img src="{{ $gateway['logo'] }}" alt="{{ $gateway['name'] }}" class="w-full h-full object-cover">
                                        @else
                                ...
                                <div class="text-xs text-gray-500 line-clamp-1">{{ $gateway['description'] ?? 'Pay securely via ' . $gateway['name'] }}</div>
                            </label>
                            @endif
                        @endforeach
                    </div>
