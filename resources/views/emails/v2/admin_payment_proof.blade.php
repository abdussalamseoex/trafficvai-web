...
<tr><td style="background:#fff;padding:36px 40px;">
  ...
  <h1 style="margin:0 0 20px;font-size:26px;font-weight:700;color:#111827;letter-spacing:-0.5px;">Payment Proof for Order <span style="color:#E8470A;">#{{ $order_id }}</span></h1>
  ...
  <tr><td style="padding:20px 24px;">
    <p style="margin:0 0 14px;font-size:11px;text-transform:uppercase;letter-spacing:1.5px;color:#E8470A;font-weight:600;font-family:'JetBrains Mono',monospace;">💳 Payment Details</p>
    <table width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr><td style="padding:8px 0;border-bottom:1px solid rgba(255,237,213,0.5);"><span style="font-size:13px;color:#6b7280;">Submitted By</span></td><td align="right" style="padding:8px 0;border-bottom:1px solid rgba(255,237,213,0.5);"><span style="font-size:13px;color:#111827;font-weight:600;">{{ $client_name }}</span></td></tr>
    <tr><td style="padding:8px 0;border-bottom:1px solid rgba(255,237,213,0.5);"><span style="font-size:13px;color:#6b7280;">Submitted At</span></td><td align="right" style="padding:8px 0;border-bottom:1px solid rgba(255,237,213,0.5);"><span style="font-size:13px;color:#111827;font-weight:600;font-family:'JetBrains Mono',monospace;">{{ $submission_date }}</span></td></tr>
  ...
  <tr>
    <td style="background:linear-gradient(135deg,#E8470A,#ea580c);border-radius:10px;padding-right:12px;">
    ...
    <td style="padding-left:4px;border:1.5px solid #E8470A;border-radius:10px;">
      <a href="{{ $admin_panel_url }}" style="display:inline-block;padding:12px 24px;font-size:14px;font-weight:600;color:#E8470A;text-decoration:none;">❌ Reject</a>
    </td>
  </tr>
  </table>
