...
<tr><td style="background:linear-gradient(135deg,#1e1b4b 0%,#312e81 40%,#1d4ed8 100%);padding:36px 40px 28px;">
  ...
  <tr><td style="padding-top:20px;">
    <span style="display:inline-flex;align-items:center;background:rgba(255,255,255,0.12);border:1px solid rgba(255,255,255,0.2);border-radius:100px;padding:6px 16px;">
      ...
      <span style="font-size:11px;color:rgba(255,255,255,0.9);font-family:'JetBrains Mono',monospace;letter-spacing:0.5px;">NEW ORDER ALERT</span>
    </span>
  </td></tr>
  </table>
</td></tr>
...
<tr><td style="background:#fff;padding:36px 40px;">
  ...
  <h1 style="margin:0 0 20px;font-size:26px;font-weight:700;color:#111827;letter-spacing:-0.5px;">New Order <span style="color:#4f46e5;">#{{ $order_id }}</span> Received</h1>
  ...
  <tr><td style="padding:20px 24px;">
    <p style="margin:0 0 14px;font-size:11px;text-transform:uppercase;letter-spacing:1.5px;color:#6d28d9;font-weight:600;font-family:'JetBrains Mono',monospace;">📦 Order Summary</p>
    <table width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr><td style="padding:8px 0;border-bottom:1px solid rgba(221,214,254,0.5);"><span style="font-size:13px;color:#6b7280;">Client Name</span></td><td align="right" style="padding:8px 0;border-bottom:1px solid rgba(221,214,254,0.5);"><span style="font-size:13px;color:#111827;font-weight:600;">{{ $client_name }}</span></td></tr>
    <tr><td style="padding:8px 0;border-bottom:1px solid rgba(221,214,254,0.5);"><span style="font-size:13px;color:#6b7280;">Order Amount</span></td><td align="right" style="padding:8px 0;border-bottom:1px solid rgba(221,214,254,0.5);"><span style="font-size:13px;color:#4f46e5;font-weight:600;font-family:'JetBrains Mono',monospace;">{{ $order_amount }}</span></td></tr>
    <tr><td style="padding:8px 0;border-bottom:1px solid rgba(221,214,254,0.5);"><span style="font-size:13px;color:#6b7280;">Status</span></td><td align="right" style="padding:8px 0;border-bottom:1px solid rgba(221,214,254,0.5);"><span style="font-size:12px;font-weight:600;background:#fef3c7;color:#92400e;padding:4px 12px;border-radius:100px;">🟡 Awaiting Review</span></td></tr>
