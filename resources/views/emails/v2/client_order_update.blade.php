...
<tr><td style="background:#fff;padding:36px 40px;">
  ...
  <tr><td style="padding:20px 24px;">
    <p style="margin:0 0 14px;font-size:11px;text-transform:uppercase;letter-spacing:1.5px;color:#E8470A;font-weight:600;font-family:'JetBrains Mono',monospace;">📋 Order Status</p>
    <table width="100%" cellpadding="0" cellspacing="0">
