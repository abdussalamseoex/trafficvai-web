...
Route::middleware(['auth'])->group(function () use ($seoTypes) {
    ...
    Route::middleware(\App\Http\Middleware\IsAdmin::class)->prefix('admin')->name('admin.')->group(function () {
            ...
            Route::get('/traffic-campaigns/{campaign}/edit', [\App\Http\Controllers\Admin\TrafficCampaignAdminController::class, 'edit'])->name('traffic_campaigns.edit');
    ...
    Route::group(['prefix' => 'client', 'as' => 'client.'], function () use ($seoTypes) {
        Route::get('/dashboard', [\App\Http\Controllers\User\DashboardController::class , 'index'])->name('dashboard');
            ...
            // Interactive Traffic Campaign Builder & Live Monitoring (surf.abguestpost.net Core Engine)
